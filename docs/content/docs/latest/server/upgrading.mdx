...
<Tabs items={['Production', 'Local / test']}>
<Tab value="Production">
Published image (`docker-compose.prod.yml`) — pull the new tag and recreate:
...
<Tab value="Local / test">
Builds from source (`docker-compose.local.yml`):
